...
import { toggleWishlistItem } from "@/app/actions/wishlist-management";
...
import { Car as TCar, TestDriveInfo } from "@/lib/types";
...
export function CarDetails({
  ...
  const handleSaveCar = async () => {
    ...
    setSavingCar(true);
    try {
      const result = await toggleWishlistItem(car.id);

      if (result.success) {
        setIsWishlisted(result.data?.saved || false);
