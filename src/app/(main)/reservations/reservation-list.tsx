...
import { cancelDriveBooking } from "@/app/actions/booking-management";
...
export function ReservationsList({
  ...
  initialData?: { success: boolean; data?: ReservationItem[]; error?: string };
}) {
  ...
  const handleCancelBooking = async (bookingId: string) => {
    setCancelling(true);
    try {
      const result = await cancelDriveBooking(bookingId);
